...
Home Manager follows `master`, plasma-manager configures KDE Plasma 6, and reusable modules use a custom option namespace: `my.system.*` for NixOS modules and `my.*` for Home Manager modules.
