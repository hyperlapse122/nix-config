...
- [ ] Change a setting the repository does not declare, rebuild, and confirm it survived. Then change a declared one, rebuild, and confirm it returned to the declared value. This is the tier split working; a declared key that survives means the merge did not run.
