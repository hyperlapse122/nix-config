...
zsh, Git, Ghostty, Claude Code, omp, gh, glab, 1Password GUI, and Google Chrome. Coding-agent logins, settings, and plugins are not migrated. macOS and Linux distributions other than NixOS are future work.
